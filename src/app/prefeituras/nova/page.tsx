...
export default function NovaPrefeituraPage({
  ...
  return (
    <main className="mx-auto max-w-lg px-6 py-10">
      ...
      <h1 className="mt-4 text-xl font-semibold">Nova prefeitura</h1>
      <p className="mt-1 text-sm text-neutral-400">
        Ao criar, os 22 setores padrão já nascem cadastrados automaticamente — dá pra editar,
        excluir ou adicionar outros depois.
      </p>
      ...
      <form action="/api/prefeituras" method="POST" className="mt-6 flex flex-col gap-4">
        <div>
          <label className="text-xs text-neutral-400">Nome da prefeitura</label>
          <input
            type="text"
            name="nome"
            required
