...
/**
 * Exige login em todo o painel administrativo (prefeituras, setores, guardrails, relatórios) —
 * só o webhook do Instagram fica de fora, porque quem chama ele é a própria Meta (servidor a
 * servidor, sem navegador nem cookie de sessão).
 *
